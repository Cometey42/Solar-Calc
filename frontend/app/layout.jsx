            ...
            <div className="flex justify-between items-center">
              <Link href="/" className="flex items-center">
                ...
                {/* <Link href="/appointments" className="text-gray-600 hover:text-[#053e7f] text-sm font-medium">
                  SCHEDULE
                </Link> */}                <Link href="/projects" className="text-gray-600 hover:text-[#053e7f] text-sm font-medium">
                  PROJECTS
                </Link>                <Link href="/project-archives" className="text-gray-600 hover:text-[#053e7f] text-sm font-medium">
                  PROJECT ARCHIVES
                </Link>                <Link href="/feoc-calculator" className="text-gray-600 hover:text-[#053e7f] text-sm font-medium">
                  FEOC CALCULATOR
                </Link>
              </nav>
            </div>
