  ...
  useEffect(() => {
    ...
    const loadProjects = async () => {
      try {
        ...
        // Show empty state if backend isn't available
        setProjects([]);
        setFilteredProjects([]);
        setTotalPages(1);
      } finally {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Only show Success Factors and Challenges if data exists */}
              {((Array.isArray(selectedProject.successFactors) && selectedProject.successFactors.length > 0) || 
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {/* Success Factors - only show if has data */}
                  {Array.isArray(selectedProject.successFactors) && selectedProject.successFactors.length > 0 && (
                    <div>
                  ...
                  {/* Challenges Overcome - only show if has data */}
                  {selectedProject.challenges && selectedProject.challenges !== 'N/A' && (
                    <div>
